...
export class SignupPage { 
  ...
  constructor(public natStorage : NativeStorage , public userProvider : UsersProvider , public formBuilder : FormBuilder , public navCtrl: NavController, public navParams: NavParams) {
    this.buildForm();
  }
